...
public class MNBArfolyamServiceSoapImplLocator extends org.apache.axis.client.Service implements hu.webtown.webshop.web.soap.MNBArfolyamServiceSoapImpl {
    ...
    public hu.webtown.webshop.web.soap.MNBArfolyamServiceSoap getCustomBinding_MNBArfolyamServiceSoap() throws javax.xml.rpc.ServiceException {
    ...
    public hu.webtown.webshop.web.soap.MNBArfolyamServiceSoap getCustomBinding_MNBArfolyamServiceSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
        	hu.webtown.webshop.web.soap.CustomBinding_MNBArfolyamServiceSoapStub _stub = new hu.webtown.webshop.web.soap.CustomBinding_MNBArfolyamServiceSoapStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (hu.webtown.webshop.web.soap.MNBArfolyamServiceSoap.class.isAssignableFrom(serviceEndpointInterface)) {
            	hu.webtown.webshop.web.soap.CustomBinding_MNBArfolyamServiceSoapStub _stub = new hu.webtown.webshop.web.soap.CustomBinding_MNBArfolyamServiceSoapStub(new java.net.URL(CustomBinding_MNBArfolyamServiceSoap_address), this);
                _stub.setPortName(getCustomBinding_MNBArfolyamServiceSoapWSDDServiceName());
                return _stub;
            }
        }
